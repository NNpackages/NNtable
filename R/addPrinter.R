...
#' @param type \code{character} dictating the ouput format
#' @param ... Additional arguments for the specific print method
#'
#' @return An object of class NNTable with the printer specified
#' @export
#' @examples
#' ## *****************************************************************************
...
#' # View the table
#' .NNTable
#' .NNTable %>% addPrinter(type = "flextable")
#'
#'
