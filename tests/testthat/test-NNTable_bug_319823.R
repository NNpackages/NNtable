...
context("Test NNTable bug 319823")
...
test_that("Bug 319823 baseline + exp", {
...
test_that("Bug 319823 baseline + filling ", {
...
test_that("Bug 319823 baseline + filling + exp", {
